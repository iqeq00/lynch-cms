...
function resourceUpdate(){
	$.post("admin/resourceUpdate.jspx",$("#resourceForm").serializeArray(),
		function(data){
...
<form id="resourceForm" method="post">
	<div >
		...
		<input type="hidden" name="resourceCreateTime" />
		...
		<a class="easyui-linkbutton" id="btn-update" iconCls="icon-save" onclick="resourceUpdate();"  >修改</a>
